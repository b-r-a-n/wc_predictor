...
export class WcSimulator {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        WcSimulatorFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wcsimulator_free(ptr, 0);
    }
    /**
     * Clear any fixed results previously set on this simulator.
     */
    clearFixedResults() {
        wasm.wcsimulator_clearFixedResults(this.__wbg_ptr);
    }
    /**
     ...
     */
    getGroups() {
        const ret = wasm.wcsimulator_getGroups(this.__wbg_ptr);
        if (ret[2]) {
     ...
     */
    getTeams() {
        const ret = wasm.wcsimulator_getTeams(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * });
     * ```
     * @param {any} tournament_json
     */
    constructor(tournament_json) {
        const ret = wasm.wcsimulator_new(tournament_json);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        WcSimulatorFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    numGroups() {
        const ret = wasm.wcsimulator_numGroups(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    numTeams() {
        const ret = wasm.wcsimulator_numTeams(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     * @returns {any}
     */
    runEloSimulation(iterations, seed) {
        const ret = wasm.wcsimulator_runEloSimulation(this.__wbg_ptr, iterations, !isLikeNone(seed), isLikeNone(seed) ? BigInt(0) : seed);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    runMarketValueSimulation(iterations, seed) {
        const ret = wasm.wcsimulator_runMarketValueSimulation(this.__wbg_ptr, iterations, !isLikeNone(seed), isLikeNone(seed) ? BigInt(0) : seed);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {any} value
     */
    setFixedResults(value) {
        const ret = wasm.wcsimulator_setFixedResults(this.__wbg_ptr, value);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
}
if (Symbol.dispose) WcSimulator.prototype[Symbol.dispose] = WcSimulator.prototype.free;
 ...
 * @param {number} team_a_elo
 * @param {number} team_b_elo
 * @param {boolean} is_knockout
 * @returns {any}
 */
export function calculateMatchProbability(team_a_elo, team_b_elo, is_knockout) {
    const ret = wasm.calculateMatchProbability(team_a_elo, team_b_elo, is_knockout);
    return ret;
}
 ...
 * @returns {any}
 */
export function simulateSingleTournament(tournament_json, strategy, seed) {
    const ptr0 = passStringToWasm0(strategy, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.simulateSingleTournament(tournament_json, ptr0, len0, seed);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./wc_wasm_bg.js": import0,
    };
}

const WcSimulatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wcsimulator_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wc_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
