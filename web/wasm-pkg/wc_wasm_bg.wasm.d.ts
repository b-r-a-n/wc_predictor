...
export const wcsimulator_numGroups: (a: number) => number;
export const wcsimulator_numTeams: (a: number) => number;
export const wcsimulator_runCompositeSimulation: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: bigint) => [number, number, number];
export const wcsimulator_runEloSimulation: (a: number, b: number, c: number, d: bigint) => [number, number, number];
